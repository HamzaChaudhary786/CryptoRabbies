...
const Signup = () => {
  return (
    <>
      <div className="p-24 grid justify-center justify-items-center bg-gradient-to-r from-purple-600 via-purple-400  to-purple-300">
        <div className=" border border-blue-500 shadow-xl shadow-blue-600 h-[650px] w-[400px] grid items-center justify-center   rounded-lg hover:border hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-800  duration-500 ">
          <div className="h-[600px] w-[300px] font-semibold text-white ">
